subroutine calc_dimensionless_numbers(j)
    ...
    !do i=1, ncomp-1
        ...
        avg_celerity = (celerity(1,j) + celerity(ncomp,j)) / 2.0    ! 'celerity2' is calculated celerity. 'celerity' is spatially averaged
        i = 1
        wl_us = newY(i,j)
        ...
        channel_length = sum(dx(1:ncomp-1,j))
        ...
        dimlessWaveLength = channel_length/avg_depth
